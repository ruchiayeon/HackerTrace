...
import com.ht.dao.ConfigLogDAO;
import com.ht.util.DateUtil;
import com.ht.util.FileUtil;
import com.ht.vo.ConfigContentsVO;
import com.ht.vo.ConfigLogContentsVO;
import com.ht.vo.ConfigLogHistoryVO;
import com.ht.vo.ConfigLogListVO;
import com.ht.vo.ConfigLogMessageVO;
import com.ht.vo.ConfigLogPathsVO;
import com.ht.vo.ConfigLogSesCondVO;
import com.ht.vo.ConfigLogSessionsVO;
import com.ht.vo.ConfigLogVO;
import com.ht.vo.DirectoryTopVO;
import com.ht.vo.DirectoryVO;
	...
	public List<Document> selectConfigFileDirectory(DirectoryTopVO vo){
		...
		try {
			...
			for(Document doc:dao.selectConfigFileDirectory(vo)) {
				...
				int diff = docPathSplit.length - nextPathDepth;
				if(diff > 0) {
